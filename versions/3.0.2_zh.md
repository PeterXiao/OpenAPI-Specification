...
媒体类型定义分布在多个资源中。媒体类型定义应该符合 [RFC6838](https://tools.ietf.org/html/rfc6838).
...
HTTP状态码用于指示已执行操作的状态。
可用状态码由 [RFC7231](https://tools.ietf.org/html/rfc7231#section-6) 定义，注册状态码列在 [IANA Status Code Registry](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml).
